...
class Material {
  ...
  specular_exponent;
  refractive_index
  constructor(diffuse_color, albedo = [1, 0, 0, 0], specular_exponent = 0, refractive_index = 0) {
...
function cast_ray(orig, dir, spheres, lights, depth = 0) {
  const material = {};
  const hit_info = {
    hit: new Vec3(0, 0, 0),
    N: new Vec3(0, 0, 0),
...
function* render(ctx) {
  ...
  spheres.push(new Sphere(new Vec3(-1.0, -1.5, -12), 2, mirror));
